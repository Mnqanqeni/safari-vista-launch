        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="hidden lg:block">
            ...
            <ul className="space-y-4 text-white/80">
              ...
              <li><a href="#destinations" className="hover:text-safari-gold transition-colors duration-300 text-base">Activity Guide</a></li>
            </ul>
          </div>
            ...
            <div className="space-y-3 md:space-y-4 text-white/80">
              ...
              <div className="flex items-center justify-center md:justify-start space-x-3">
                ...
                <div>
                  ...
                  <p className="font-medium text-sm md:text-base">info@lafamilytour.co.za</p>
                </div>
              </div>
            </div>
          </div>
